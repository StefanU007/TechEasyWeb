...
<template>
  <div
    ...
    :style="`color: ${appStore.selectedColor.three}; font-family: ${appStore.fonts[appStore.selectedFont]}; background-image: url(/assets/images/templates/3.avif);`"
  >
    <!-- Header -->
    ...
    <!-- Main Section -->
    <div class="flex flex-col lg:flex-row pt-10 px-2 sm:px-5 mb-16 gap-8">
      <!-- Name Section -->
...
const images = ref([
    { src: "/assets/template-3/1.jpeg" },
    { src: "/assets/template-3/2.jpeg" },
    { src: "/assets/template-3/3.jpeg" },
    { src: "/assets/template-3/4.jpeg" },
    { src: "/assets/template-3/5.jpeg" },
    { src: "/assets/template-3/6.jpeg" },
    { src: "/assets/template-3/7.jpeg" },
    { src: "/assets/template-3/8.jpeg" }
]);
