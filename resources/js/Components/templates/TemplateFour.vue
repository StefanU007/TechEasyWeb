<!--Construction Template 2nd page-->
<template>
  <div
    id="template"
    class="bg-[#f6f2ea] w-full min-h-screen bg-cover bg-center bg-no-repeat"
    contenteditable="true"
    :style="`color: ${appStore.selectedColor.three}; font-family: ${appStore.fonts[appStore.selectedFont]}; background-image: url(/assets/images/templates/4.avif);`"
  >
    <!-- Header -->
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-1 px-2">
        ...
        >
          ...
          <span
            ...
            class="absolute top-2 right-2 bg-white p-1 shadow cursor-pointer rounded-full"
          >
            <!-- Edit Icon SVG -->
            <svg
