<!--Restaurant Template (FIRST PAGE)-->
<template>
  <div
    id="template"
    class="w-full min-h-screen bg-bottom bg-no-repeat"
    contenteditable="true"
    :style="`color: ${appStore.selectedColor.three}; 
    font-family: ${appStore.fonts[appStore.selectedFont]}; 
    background-image: url(/assets/images/templates/17.png), linear-gradient(to top, #050607, #0e2b30);
