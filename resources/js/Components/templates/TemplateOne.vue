<!--Finance Template 2nd page-->
<template>
  <div
    id="template"
    class="bg-[#f6f2ea] w-full min-h-screen bg-cover bg-center bg-no-repeat"
    contenteditable="true"
    :style="`color: ${appStore.selectedColor.three}; font-family: ${appStore.fonts[appStore.selectedFont]}; background-image: url(/assets/images/templates/1.webp);`"
  >
    <!-- Header -->
...
const images = ref([
    { src: "/assets/template-1/1.jpeg" },
    { src: "/assets/template-1/2.jpeg" },
    { src: "/assets/template-1/3.jpeg" },
    { src: "/assets/template-1/4.jpeg" },
    { src: "/assets/template-1/5.jpeg" },
    { src: "/assets/template-1/6.jpeg" },
    { src: "/assets/template-1/7.jpeg" },
    { src: "/assets/template-1/8.jpeg" }
]);
