<!--Construction Template (FIRST PAGE)-->
<template>
  <div
    id="template"
    class="bg-[#f6f2ea] w-full min-h-screen bg-cover bg-center bg-no-repeat"
    contenteditable="true"
    :style="`color: ${appStore.selectedColor.three}; font-family: ${appStore.fonts[appStore.selectedFont]}; background-image: url(/assets/images/templates/13.png);`"
  >
    <!-- Header -->
    <div class="px-2 sm:px-4 py-4 flex flex-col sm:flex-row items-center justify-between bg-[#333333] z-20">
      <img
        ...
        class="w-24 h-14 object-scale-down mb-2 sm:mb-0 sm:ml-6"
        alt="Logo"
      />
      <img
        v-else
    ...
    <!-- Main Section: Name & Info + Description/Image Grouped Right -->
    <div class="flex flex-col md:flex-row md:items-start px-2 sm:px-5 pt-10 mb-16">
      <!-- Name/Info Section -->
      <div class="flex-1 flex flex-col items-center md:items-start">
        <div class="relative w-full max-w-xl mx-auto" @click="hideEditIcon('name')">
          <div
            ...
            class="absolute left-1/2 -translate-x-1/2 md:left-48 md:translate-x-0 -top-14 bg-gray-200 p-2 rounded-lg shadow-lg"
          >
            <p class="text-gray-800 text-sm">Click to edit</p>
            <div class="w-1 h-5 bg-gray-200 absolute top-full left-1/2 md:left-12 -ml-1 md:ml-0 shadow-lg"></div>
          </div>
          <h1
      ...
      <!-- Description/Image Section: Always grouped, right-aligned on desktop/tablet -->
      <div class="w-full md:w-1/2 flex flex-col items-center md:items-end md:ml-auto mt-10 md:mt-0">
        <div class="w-full max-w-2xl">
          ...
          <img
            v-else
            src="/assets/template-8/dina-seafood-1.png"
        ...
        >
          ...
          <div
            ...
            class="mt-12 absolute left-1/2 -translate-x-1/2 md:left-auto md:right-0 md:translate-x-0 -top-12 md:-top-14 bg-gray-200 p-2 md:p-4 rounded-lg shadow-lg w-40 md:w-56 text-xs md:text-sm z-50 text-center transition-all"
          >
            <p class="text-gray-800 text-sm text-center">Click to edit</p>
            <div
              class="w-1 h-5 bg-gray-200 absolute top-full left-1/2 -translate-x-1/2 md:left-auto md:right-6 md:translate-x-0 shadow-lg"
            ></div>
          </div>
          <p
    ...
    <section class="container mx-auto px-4 pt-16">
      ...
      <div class="pb-4 grid grid-cols-3 md:grid-cols-3 gap-8 text-center text-[#274EBA]">
        <div>
          <h3
...
const images = ref([
  { src: "/assets/template-4/1.jpeg" },
  { src: "/assets/template-4/2.jpeg" },
  { src: "/assets/template-4/3.jpeg" },
  { src: "/assets/template-4/4.jpeg" },
  { src: "/assets/template-4/5.jpeg" },
  { src: "/assets/template-4/6.jpeg" },
  { src: "/assets/template-4/7.jpeg" },
  { src: "/assets/template-4/8.jpeg" },
]);
