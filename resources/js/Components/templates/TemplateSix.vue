<!-- Non-Profit Template 2nd Page-->
<template>
  <div
    id="template"
    class="bg-[#f6f2ea] w-full min-h-screen bg-cover bg-center bg-no-repeat"
    contenteditable="true"
    :style="`color: ${appStore.selectedColor.three}; font-family: ${appStore.fonts[appStore.selectedFont]}; background-image: url(/assets/images/templates/6.webp);`"
  >
    <!-- Header -->
...
const images = ref([
    { src: "/assets/template-6/1.jpeg" },
    { src: "/assets/template-6/2.jpeg" },
    { src: "/assets/template-6/3.jpeg" },
    { src: "/assets/template-6/4.jpeg" },
    { src: "/assets/template-6/5.jpeg" },
    { src: "/assets/template-6/6.jpeg" },
    { src: "/assets/template-6/7.jpeg" },
    { src: "/assets/template-6/8.jpeg" }
]);
